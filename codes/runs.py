...
from models import KGEModel, ANStransE
...
def parse_args(args=None):
    ...
    parser.add_argument('-meanw', '--mean_weight', default=0.5, type=float)
...
def main(args):
    ...
    kge_model = ANStransE(num_entity, num_relation, args.hidden_dim, args.gamma)
    ...
    #kge_model.init_clusters(train_iterator)################################
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps):
            ...
            log = kge_model.train_step(kge_model, optimizer, train_iterator, args, loss_list)
        ...
        KGEModel.plot_loss_curve(loss_list)
